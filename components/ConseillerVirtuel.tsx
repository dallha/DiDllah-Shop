...
export default function ConseillerVirtuel() {
  ...
  const whatsappHref = whatsappToHref(brand.whatsapp, 'Bonjour DiDallah Shop ! Je viens de discuter avec le conseiller virtuel et j\'aimerais un renseignement complémentaire.');
